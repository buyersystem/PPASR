...
|:---------:|:-----------------------------:|:----:|:----------------------:|:-------:|:--------:|
| Conformer |             粤语数据集             |  粤语  |   ctc_greedy_search    | 0.05736 | 加入知识星球获取 |
| Conformer |             粤语数据集             |  粤语  | ctc_prefix_beam_search | 0.05730 | 加入知识星球获取 |
| Conformer |             粤语数据集             |  粤语  |  attention_rescoring   | 0.04877 | 加入知识星球获取 |
| Conformer |             粤语数据集             |  粤语  |    ctc_beam_search     | 0.05409 | 加入知识星球获取 |
